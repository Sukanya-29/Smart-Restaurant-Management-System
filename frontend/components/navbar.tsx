...
import { Menu, X, ShoppingCart, User, Bot, LogOut } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-orange-100 bg-white/80 backdrop-blur-lg">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="rounded-xl p-3 transition hover:bg-orange-100 md:hidden"
          >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-orange-100 bg-white px-6 py-5 shadow-xl space-y-4">
          <Link
            href="/"
          ...
          <button
            ...
            className="w-full text-left font-medium text-gray-700 transition hover:text-orange-500"
          >
            🍽️ Request Service
          </button>
        </div>
